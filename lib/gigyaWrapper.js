...
/***/ function(module, exports, __webpack_require__) {
	...
	var GigyaWrapper = function () {
	  ...
	  _createClass(GigyaWrapper, [{
	    ...
	    key: 'showLoginScreen',
	    value: function showLoginScreen(opts) {
	      this.showScreenSet({
	    ...
	    value: function getSchema(opts) {
	      ...
	      return new Promise(function (resolve, reject) {
	        var schemaProps = Object.assign({
	          context: {},
	          callback: function callback(response) {
	            return _this5.cb(resolve, reject, response);
	          }
	        }, opts);
	
	        _this5.gigya.accounts.getSchema(schemaProps);
	      });
	    }
	  }, {
	    key: 'getPolicies',
	    value: function getPolicies(opts) {
	      ...
	      return new Promise(function (resolve, reject) {
	        var policiesProps = Object.assign({
	          ...
	          context: {},
	          callback: function callback(response) {
	            return _this6.cb(resolve, reject, response);
	          }
	        }, opts);
	    ...
	    value: function getScreenSets(opts) {
	      ...
	      return new Promise(function (resolve, reject) {
	        var screenSetsProps = Object.assign({
	          ...
	          context: {},
	          callback: function callback(response) {
	            return _this7.cb(resolve, reject, response);
	          }
	        }, opts);
	    ...
	    key: 'cb',
	    value: function cb(resolve, reject, response) {
...
;
//# sourceMappingURL=gigyaWrapper.js.map